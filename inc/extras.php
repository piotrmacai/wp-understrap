...
if (!function_exists('understrap_all_excerpts_get_more_link')) {
	...
	{
		if (!is_admin()) {
			$post_excerpt = $post_excerpt . ' [...]<p><a class="button orange arrow understrap-read-more-link" href="' . esc_url(get_permalink(get_the_ID())) . '">' . 'Czytaj ' . '<span class="screen-reader-text"> from ' . get_the_title(get_the_ID()) . '</span></a></p>';
		}
		return $post_excerpt;
	}
}
